...
class LSUNData():
    def __init__(self, bs):
        ...
        imgs = glob.glob("./data/lsun1/bedroom/0/0/**/*.jpg", recursive=True)+glob.glob("./data/lsun1/bedroom/0/1/**/*.jpg", recursive=True)
...
def main():
    ...
    clvm = CLVM_Stack(data, use_kl = True)
    clvm.stack_latent(m.Deconv2d, {"k": 5, "stride": 1, "i_pad":0, "i_chan": 16, "h_chan": 32}, opt_class, opt_params, 0.002)
